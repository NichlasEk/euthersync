...
password hashes directly, reading the attempted password from stdin. This keeps
EutherSync login attempts out of EutherOxide's shared localhost rate-limit bucket.
